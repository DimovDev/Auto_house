...
class UserProfileManager(BaseUserManager):
    ...
    def create_user(self, email, name, password=None):
        """Creates a new users with the given detials."""

        # Check that the users provided an email.
        if not email:
    ...
    def create_superuser(self, email, name, password):
        ...
        # Create a new users with the function we created above.
...
class Message(models.Model):
    """A users message from one users to another."""
